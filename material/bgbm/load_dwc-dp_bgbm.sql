...
\copy public.collection FROM './input_data/datapackage-download/collection.csv' WITH (FORMAT CSV, HEADER);
\copy public.event FROM './input_data/datapackage-download/event.csv' WITH (FORMAT CSV, HEADER);
--\copy public.genetic_sequence FROM './input_data/datapackage-download/genetic-sequence.csv' WITH (FORMAT CSV, HEADER);
