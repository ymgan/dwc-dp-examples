...
\COPY event_agent_role TO './output_data/event_agent_role.tsv' WITH (FORMAT TEXT, DELIMITER E'\t', NULL '', HEADER);
\COPY event_assertion TO './output_data/event_assertion.tsv' WITH (FORMAT TEXT, DELIMITER E'\t', NULL '', HEADER);
\COPY event_protocol TO './output_data/event_protocol.tsv' WITH (FORMAT TEXT, DELIMITER E'\t', NULL '', HEADER);
\COPY event TO './output_data/event.tsv' WITH (FORMAT TEXT, DELIMITER E'\t', NULL '', HEADER);
\COPY identification_agent_role TO './output_data/identification_agent_role.tsv' WITH (FORMAT TEXT, DELIMITER E'\t', NULL '', HEADER);
...
\COPY survey_agent_role TO './output_data/survey_agent_role.tsv' WITH (FORMAT TEXT, DELIMITER E'\t', NULL '', HEADER);
