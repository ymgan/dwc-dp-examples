...
\copy public.input_event_agent_role FROM './input_data/event_agent_role.txt' WITH (DELIMITER E'\t', FORMAT CSV, HEADER);
--\copy public.input_event_assertion FROM './input_data/event_assertion.txt' WITH (DELIMITER E'\t', FORMAT CSV, HEADER);
\copy public.input_event_protocol FROM './input_data/event_protocol.txt' WITH (DELIMITER E'\t', FORMAT CSV, HEADER);
\copy public.input_event FROM './input_data/event.txt' WITH (DELIMITER E'\t', FORMAT CSV, HEADER);
\copy public.input_identification_agent_role FROM './input_data/identification_agent_role.txt' WITH (DELIMITER E'\t', FORMAT CSV, HEADER);
...
\copy public.input_survey_agent_role FROM './input_data/survey_agent_role.txt' WITH (DELIMITER E'\t', FORMAT CSV, HEADER);
